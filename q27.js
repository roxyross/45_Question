...
if (display === 'green' || display === 2) {
    ...
    console.log("".concat(alien_color[display], "You Earned 10 points."));
}
else if (display == 'Red' || display === 0) {
    console.log("".concat(alien_color[display], "You Earned 15 points."));
}
else {
    console.log("".concat(alien_color[display], "You Earned 0 points."));
}
